            ...
            for task in pred_target:
                for loss_name in loss_dict:
                    if task in loss_name:
                        ...
                        log_interface(key=log_key, value=task_loss.item(), mode='train')
                ...
                for metric in metric_dict:    
                    if task in metric:
                        ...
                        log_interface(key=log_key, value=value, mode='train')
                ...
                for task in pred_target:
                    for loss_name in loss_dict:
                        if task in loss_name:
                            ...
                            log_interface(key=log_key, value=task_loss.item(), mode='valid')
                    ...
                    for metric in metric_dict:    
                        if task in metric:
                            ...
                            log_interface(key=log_key, value=value, mode='valid')

                if batch == 1:
                    break 
        
        print(log_interface.log)
        print(log_interface.cnt)
        print(log_interface.epoch)
